    ...
    <div class="col-lg-12">
            <section class="panel">
                <header class="panel-heading">
                    <b class="text-danger">Thêm sản phẩm</b>
                </header>
                <div class="panel-body">
                    ...
                    <div class="position-center">
                        ...
                        <div class="form-group"  >
                            ...
                            <select name="product_cate" class="form-control input-lg m-bot15" style="font-size: 14px;">
                        ...
                        <div class="form-group">
                            ...
                            <select name="product_brand" class="form-control input-lg m-bot15" style="font-size: 14px;">
                        ...
                        <div class="form-group">
                            ...
                            <select name="product_status" class="form-control input-lg m-bot15" style="font-size: 14px;">
